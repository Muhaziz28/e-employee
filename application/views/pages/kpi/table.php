        ...
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="col-lg-6" style="margin-top: 50px;">
                        ...
                        <a href="#" class="btn btn-info float-right mt-3" id="btnFilterKpi"><i class="fas fa-filter mr-2"></i>Filter<img src="<?= base_url("assets/img/load/load2.svg"); ?>" width="25px;" id="loadBtnFilter"></a>
