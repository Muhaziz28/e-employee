...
$tgl_mulai_kontrak = $this->session->userdata('tgl_mulai_kontrak');
$tgl_akhir_kontrak = $this->session->userdata('tgl_akhir_kontrak');
...
$tgl_mulai_kontrak2 = new DateTime($tgl_mulai_kontrak);
$tgl_akhir_kontrak2 = new DateTime($tgl_akhir_kontrak);

$diff2 = date_diff($tgl_mulai_kontrak2, $tgl_akhir_kontrak2);

if ($tgl_akhir_kontrak2 <= $tgl_sekarang) {
    $sisa = '<span class="text-danger">Kontrak Habis</span>';
} else {
    $d = $tgl_akhir_kontrak2->diff($tgl_sekarang)->days;
...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url("profile") ?>"></a>My Profile</li>
        </ol>
    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p><?= $email; ?></p>
                        <a href="#" class="btn btn-info" id="btnRiwayatGaji" data-nip="<?= $nip; ?>">Lihat Riwayat Gaji&nbsp;<img src="<?= base_url("assets/img/load/load2.svg"); ?>" width="25px;" class="loadBtnGaji"></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($status_pegawai == "Kontrak") : ?>
                                        <?= $sisa . " <strong>(berakhir tgl : " . date_format($tgl_akhir_kontrak2, "d-m-Y") . ")</strong>"; ?>
                                    <?php else : ?>
                                        -
                                    <?php endif ?>
                                </td>
