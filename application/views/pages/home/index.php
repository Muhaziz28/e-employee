                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-5 my-auto mx-auto">
                            ...
                            <h3 class="text-grey-700">Tambahkan Aktivitasmu </h3>
                            <p>
                                Aktivitas kerja yang kamu lakukan akan dinilai oleh HRD untuk menilai kinerja dan performamu.
                            </p>
                            <p><strong class="text-danger">*Ini Penting untuk Dilakukan!</strong></p>
                            <a href="#" class="btn btn-primary" id="btnTambahAktivitat" data-nip="<?= $this->session->userdata('nip'); ?>" data-toggle="modal" data-target="#modalAddActivity">TAMBAHKAN AKTIVITAS</a>
                            <a href="<?= base_url("activity"); ?>" class="btn btn-info" id="btnLihatAktivitats" data-nip="<?= $this->session->userdata('nip'); ?>">LIHAT AKTIVITAS</a>

                        </div>
                        <div class="col-lg-5">
                            <div id="anim_home" class="mx-auto" style="width: 400px;">
                            </div>
                        </div>
                    </div>
